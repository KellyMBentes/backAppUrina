...
urlpatterns = [
    ...
    path('api/medicine', include('medicines.urls', 'api_medicines')),
    path('api/adverse-reaction', include('adverseReactions.urls', 'api_adverseReactions')),
    path('api/image', include('images.urls', 'api_images'))
]
