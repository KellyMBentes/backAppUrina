...
"""
        # Post Phone (problema com o phone no personalData)

        url = "http://127.0.0.1:8000/api/personalData/phone/create/" + user.id
        ...
        url = "http://127.0.0.1:8000/api/personalData/1"
